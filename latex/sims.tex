...
\begin{description}
	...
	\item[Del-AR-P] Simulation of a passive response to an anomaly which introduces a time delay into the measurement of the state of a plant with parametric uncertainties
\end{description}
