...
\section{On-Board Human Pilot and Full-State Feedback Adaptive Autopilot} \label{sec:siso_problem}
...
\section{Remote Human Pilot and Output Feedback Adaptive Autopilot}  \label{sec:mimo_problem}
